...
Public Class rpt_TratamientoPac
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_TratamientoPac.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_TratamientoPac
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_TratamientoPac = New rpt_TratamientoPac
        rpt.Site = Me.Site
        Return rpt
    End Function
