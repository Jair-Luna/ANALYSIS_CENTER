...
Public Class rpt_contraorden
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_contraorden.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_contraorden
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_contraorden = New rpt_contraorden
        rpt.Site = Me.Site
        Return rpt
    End Function
