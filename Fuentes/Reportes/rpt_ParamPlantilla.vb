...
Public Class rpt_ParamPlantilla
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_ParamPlantilla.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ParamPlantilla
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ParamPlantilla = New rpt_ParamPlantilla
        rpt.Site = Me.Site
        Return rpt
    End Function
