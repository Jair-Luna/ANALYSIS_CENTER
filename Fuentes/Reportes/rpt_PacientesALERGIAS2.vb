...
Public Class rpt_PacientesALERGIAS2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "rpt_PacientesALERGIAS2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_PacientesALERGIAS2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_PacientesALERGIAS2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_PacientesALERGIAS2 = New rpt_PacientesALERGIAS2
        rpt.Site = Me.Site
        Return rpt
    End Function
