...
Public Class rpt_ingresosHosp
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_ingresosHosp.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ingresosHosp
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ingresosHosp = New rpt_ingresosHosp
        rpt.Site = Me.Site
        Return rpt
    End Function
