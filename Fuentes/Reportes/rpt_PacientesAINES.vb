...
Public Class rpt_PacientesAINES
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_PacientesAINES.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_PacientesAINES
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_PacientesAINES = New rpt_PacientesAINES
        rpt.Site = Me.Site
        Return rpt
    End Function
