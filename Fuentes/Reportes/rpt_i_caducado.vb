...
Public Class rpt_i_caducado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Analisys.rpt_i_caducado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_i_caducado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_i_caducado = New rpt_i_caducado
        rpt.Site = Me.Site
        Return rpt
    End Function
