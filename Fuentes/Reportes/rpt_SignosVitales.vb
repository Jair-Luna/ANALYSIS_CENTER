...
Public Class rpt_SignosVitales
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_SignosVitales.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_SignosVitales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_SignosVitales = New rpt_SignosVitales
        rpt.Site = Me.Site
        Return rpt
    End Function
