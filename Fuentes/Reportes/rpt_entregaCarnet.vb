...
Public Class rpt_entregaCarnet
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_entregaCarnet.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_entregaCarnet
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_entregaCarnet = New rpt_entregaCarnet
        rpt.Site = Me.Site
        Return rpt
    End Function
