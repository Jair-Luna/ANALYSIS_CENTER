...
Public Class rpt_aspirantes
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_aspirantes.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_aspirantes
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_aspirantes = New rpt_aspirantes
        rpt.Site = Me.Site
        Return rpt
    End Function
