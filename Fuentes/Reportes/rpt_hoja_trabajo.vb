...
Public Class rpt_hoja_trabajo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_hoja_trabajo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_hoja_trabajo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_hoja_trabajo = New rpt_hoja_trabajo
        rpt.Site = Me.Site
        Return rpt
    End Function
