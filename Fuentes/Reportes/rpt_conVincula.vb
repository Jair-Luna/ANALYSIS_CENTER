...
Public Class rpt_conVincula
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_conVincula.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_conVincula
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_conVincula = New rpt_conVincula
        rpt.Site = Me.Site
        Return rpt
    End Function
