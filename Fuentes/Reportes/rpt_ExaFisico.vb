...
Public Class rpt_ExaFisico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_ExaFisico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ExaFisico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ExaFisico = New rpt_ExaFisico
        rpt.Site = Me.Site
        Return rpt
    End Function
