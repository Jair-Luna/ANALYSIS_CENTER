...
Public Class rpt_EstCultivo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_EstCultivo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_EstCultivo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_EstCultivo = New rpt_EstCultivo
        rpt.Site = Me.Site
        Return rpt
    End Function
