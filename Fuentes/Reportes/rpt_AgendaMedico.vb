...
Public Class rpt_AgendaMedico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_AgendaMedico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_AgendaMedico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_AgendaMedico = New rpt_AgendaMedico
        rpt.Site = Me.Site
        Return rpt
    End Function
