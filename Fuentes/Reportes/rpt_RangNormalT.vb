...
Public Class rpt_RangNormalT
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_RangNormalT.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_RangNormalT
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_RangNormalT = New rpt_RangNormalT
        rpt.Site = Me.Site
        Return rpt
    End Function
