...
Public Class rpt_ConMedicoEspe
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_ConMedicoEspe.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ConMedicoEspe
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ConMedicoEspe = New rpt_ConMedicoEspe
        rpt.Site = Me.Site
        Return rpt
    End Function
