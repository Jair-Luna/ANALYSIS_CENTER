...
'     Versión del motor en tiempo de ejecución:2.0.50727.8838
'
...
Public Class rpt_est_remitidos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysCENTER.rpt_est_remitidos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_est_remitidos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_est_remitidos = New rpt_est_remitidos
        rpt.Site = Me.Site
        Return rpt
    End Function
