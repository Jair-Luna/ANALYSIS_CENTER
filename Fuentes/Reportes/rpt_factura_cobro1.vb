...
Public Class rpt_factura_cobro
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysCENTER.rpt_factura_cobro.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_factura_cobro
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_factura_cobro = New rpt_factura_cobro
        rpt.Site = Me.Site
        Return rpt
    End Function
