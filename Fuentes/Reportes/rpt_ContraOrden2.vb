...
Public Class rpt_ContraOrden2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_ContraOrden2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ContraOrden2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ContraOrden2 = New rpt_ContraOrden2
        rpt.Site = Me.Site
        Return rpt
    End Function
