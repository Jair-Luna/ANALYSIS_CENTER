...
Public Class rpt_convenios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_convenios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_convenios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_convenios = New rpt_convenios
        rpt.Site = Me.Site
        Return rpt
    End Function
