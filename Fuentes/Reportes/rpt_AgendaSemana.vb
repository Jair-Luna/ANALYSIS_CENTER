...
Public Class rpt_AgendaSemana
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Analisys.rpt_AgendaSemana.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_AgendaSemana
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_AgendaSemana = New rpt_AgendaSemana
        rpt.Site = Me.Site
        Return rpt
    End Function
