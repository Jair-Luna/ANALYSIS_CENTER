...
Public Class rpt_est_servicio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_est_servicio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_est_servicio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_est_servicio = New rpt_est_servicio
        rpt.Site = Me.Site
        Return rpt
    End Function
