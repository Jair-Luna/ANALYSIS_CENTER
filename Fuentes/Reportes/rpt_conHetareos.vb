...
Public Class rpt_conHetareos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_conHetareos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_conHetareos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_conHetareos = New rpt_conHetareos
        rpt.Site = Me.Site
        Return rpt
    End Function
