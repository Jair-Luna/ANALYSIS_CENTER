...
Public Class rpt_ConOrigen
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_ConOrigen.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_ConOrigen
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_ConOrigen = New rpt_ConOrigen
        rpt.Site = Me.Site
        Return rpt
    End Function
