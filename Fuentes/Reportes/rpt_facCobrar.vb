...
Public Class rpt_facCobrar
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_facCobrar.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_facCobrar
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_facCobrar = New rpt_facCobrar
        rpt.Site = Me.Site
        Return rpt
    End Function
