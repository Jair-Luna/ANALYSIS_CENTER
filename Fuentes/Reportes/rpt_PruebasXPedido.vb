...
Public Class rpt_PruebasXPedido
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_PruebasXPedido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_PruebasXPedido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_PruebasXPedido = New rpt_PruebasXPedido
        rpt.Site = Me.Site
        Return rpt
    End Function
