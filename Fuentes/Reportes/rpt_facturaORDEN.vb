...
Public Class rpt_facturaORDEN
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_facturaORDEN.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_facturaORDEN
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_facturaORDEN = New rpt_facturaORDEN
        rpt.Site = Me.Site
        Return rpt
    End Function
