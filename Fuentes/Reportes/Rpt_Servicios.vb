...
Public Class Rpt_Servicios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.Rpt_Servicios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedRpt_Servicios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As Rpt_Servicios = New Rpt_Servicios
        rpt.Site = Me.Site
        Return rpt
    End Function
