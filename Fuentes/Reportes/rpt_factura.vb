...
Public Class rpt_facturaRecibo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysCENTER.rpt_facturaRecibo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_facturaRecibo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_facturaRecibo = New rpt_facturaRecibo
        rpt.Site = Me.Site
        Return rpt
    End Function
