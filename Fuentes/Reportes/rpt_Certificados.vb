...
Public Class rpt_Certificados
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_Certificados.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Certificados
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Certificados = New rpt_Certificados
        rpt.Site = Me.Site
        Return rpt
    End Function
