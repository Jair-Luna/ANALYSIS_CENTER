...
Public Class rpt_FacturaRecibo2
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_FacturaRecibo2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_FacturaRecibo2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_FacturaRecibo2 = New rpt_FacturaRecibo2
        rpt.Site = Me.Site
        Return rpt
    End Function
