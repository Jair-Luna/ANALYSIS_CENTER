...
Public Class rpt_AgendaConsulta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_AgendaConsulta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_AgendaConsulta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_AgendaConsulta = New rpt_AgendaConsulta
        rpt.Site = Me.Site
        Return rpt
    End Function
