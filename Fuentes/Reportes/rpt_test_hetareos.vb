...
Public Class rpt_test_hetareos
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_test_hetareos.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_test_hetareos
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_test_hetareos = New rpt_test_hetareos
        rpt.Site = Me.Site
        Return rpt
    End Function
