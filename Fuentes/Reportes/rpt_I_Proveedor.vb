...
Public Class rpt_I_Proveedor
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Analisys.rpt_I_Proveedor.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_I_Proveedor
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_I_Proveedor = New rpt_I_Proveedor
        rpt.Site = Me.Site
        Return rpt
    End Function
