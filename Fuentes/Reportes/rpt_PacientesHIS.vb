...
Public Class rpt_PacientesHIS
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_PacientesHIS.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_PacientesHIS
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_PacientesHIS = New rpt_PacientesHIS
        rpt.Site = Me.Site
        Return rpt
    End Function
