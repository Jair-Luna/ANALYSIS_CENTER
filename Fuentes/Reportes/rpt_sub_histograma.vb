...
Public Class rpt_sub_histograma
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysCENTER.rpt_sub_histograma.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_sub_histograma
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_sub_histograma = New rpt_sub_histograma
        rpt.Site = Me.Site
        Return rpt
    End Function
