...
Public Class rpt_AutoCompletado
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_AutoCompletado.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_AutoCompletado
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_AutoCompletado = New rpt_AutoCompletado
        rpt.Site = Me.Site
        Return rpt
    End Function
