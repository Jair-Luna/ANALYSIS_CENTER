...
Public Class rpt_factura_cobros
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_factura_cobros.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_factura_cobros
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_factura_cobros = New rpt_factura_cobros
        rpt.Site = Me.Site
        Return rpt
    End Function
