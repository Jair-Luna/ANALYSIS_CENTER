...
Public Class rpt_PlanTTO_G3
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_PlanTTO_G3.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_PlanTTO_G3
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_PlanTTO_G3 = New rpt_PlanTTO_G3
        rpt.Site = Me.Site
        Return rpt
    End Function
