...
Public Class rpt_facturaAbono
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_facturaAbono.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_facturaAbono
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_facturaAbono = New rpt_facturaAbono
        rpt.Site = Me.Site
        Return rpt
    End Function
