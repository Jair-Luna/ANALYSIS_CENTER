...
Public Class rpt_RecetaMedica
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_RecetaMedica.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_RecetaMedica
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_RecetaMedica = New rpt_RecetaMedica
        rpt.Site = Me.Site
        Return rpt
    End Function
