...
Public Class rpt_cajaXmedico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_cajaXmedico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_cajaXmedico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_cajaXmedico = New rpt_cajaXmedico
        rpt.Site = Me.Site
        Return rpt
    End Function
