...
Public Class rpt_trackingCorreo
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_trackingCorreo.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_trackingCorreo
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_trackingCorreo = New rpt_trackingCorreo
        rpt.Site = Me.Site
        Return rpt
    End Function
