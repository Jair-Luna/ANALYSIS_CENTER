...
Public Class rpt_cajaXconvenio
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_cajaXconvenio.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_cajaXconvenio
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_cajaXconvenio = New rpt_cajaXconvenio
        rpt.Site = Me.Site
        Return rpt
    End Function
