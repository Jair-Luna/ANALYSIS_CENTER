...
Public Class rpt_IngresosPedido
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_IngresosPedido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_IngresosPedido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_IngresosPedido = New rpt_IngresosPedido
        rpt.Site = Me.Site
        Return rpt
    End Function
