...
Public Class rpt_recibos1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysCENTER.rpt_recibos1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_recibos1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_recibos1 = New rpt_recibos1
        rpt.Site = Me.Site
        Return rpt
    End Function
