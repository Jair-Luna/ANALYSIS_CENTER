...
Public Class rpt_PrueEjecutadas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_PrueEjecutadas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_PrueEjecutadas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_PrueEjecutadas = New rpt_PrueEjecutadas
        rpt.Site = Me.Site
        Return rpt
    End Function
