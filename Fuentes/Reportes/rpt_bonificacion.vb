...
Public Class rpt_bonificacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_bonificacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_bonificacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_bonificacion = New rpt_bonificacion
        rpt.Site = Me.Site
        Return rpt
    End Function
