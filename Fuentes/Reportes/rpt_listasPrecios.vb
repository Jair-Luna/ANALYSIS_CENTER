...
Public Class rpt_listasPrecios
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_listasPrecios.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_listasPrecios
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_listasPrecios = New rpt_listasPrecios
        rpt.Site = Me.Site
        Return rpt
    End Function
