...
Public Class rpt_listadoCuentas
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_listadoCuentas.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_listadoCuentas
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_listadoCuentas = New rpt_listadoCuentas
        rpt.Site = Me.Site
        Return rpt
    End Function
