...
Public Class rpt_I_Comprobate
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_I_Comprobate.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_I_Comprobate
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_I_Comprobate = New rpt_I_Comprobate
        rpt.Site = Me.Site
        Return rpt
    End Function
