...
Public Class rpt_est_afiliacion
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_est_afiliacion.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_est_afiliacion
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_est_afiliacion = New rpt_est_afiliacion
        rpt.Site = Me.Site
        Return rpt
    End Function
