...
Public Class rpt_Historico
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_Historico.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Historico
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Historico = New rpt_Historico
        rpt.Site = Me.Site
        Return rpt
    End Function
