...
Public Class rpt_cajaXconvenio1
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "AnalisysLAB.rpt_cajaXconvenio1.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_cajaXconvenio1
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_cajaXconvenio1 = New rpt_cajaXconvenio1
        rpt.Site = Me.Site
        Return rpt
    End Function
