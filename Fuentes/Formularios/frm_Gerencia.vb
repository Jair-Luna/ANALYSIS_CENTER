Public Class frm_Gerencia
    ...
    Private Sub frm_Agencia_load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
    ...
    Private Sub cargaDiaria(ByVal mes As Integer)
        ...
        actualizaDtsConDiario(dgv_ConsDiarioN, "N", 2024, 9, dtt_CDiarioN)
